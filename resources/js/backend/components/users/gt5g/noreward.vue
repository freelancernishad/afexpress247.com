    ...
    <main class="mb-5 pb-5">
        <div>
            ...
            <div class="bg-gds p-3  text-white">
                <p class="fs-4 fw-bold text-center text-dark">AFEXPRESS Investment Program
                </p>
...
If your TA 3 members earn 100 per day, you get 2% of 100 per day. to it. If your team has 10 members or 100 members, this will be a gender-term.</p> -->
        ...
        <div class="mt-5">
            ...
            <p class="px-3">
                ...
                <div class="bg-gds p-3  text-white">
                    <p class="fs-4 fw-bold text-center text-dark">AFEXPRESS Team Commission Program
                    </p>
                    <div class="bg-gddd p-3 rounded-1">
                        <table style="width: 100%;">
                            <thead>
